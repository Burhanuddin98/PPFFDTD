...
def create_temporary_input_file():
    ...
    geo_file = os.path.join(
        default_data_path(), "test_room_pffdtd.geo")
    msh_file = os.path.join(
        default_data_path(), "test_room_pffdtd.msh")
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        input_tmp['geo_path'] = os.path.join(
            tmpdirname, "test_room_pffdtd.geo")
        input_tmp['msh_path'] = os.path.join(
            tmpdirname, "test_room_pffdtd.msh")
...
def mock_requests_post():
    ...
    """
    with patch("pffdtd_interface.definition.requests.post") as mock_post:
